@extends('layouts.auth', ['title' => 'Register - Panzer Robotics IoT'])
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold text-uppercase">Nama</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold text-uppercase">Konfirmasi Kata Sandi</label>
                                    <input type="password" name="password_confirmation" class="form-control" placeholder="Masukkan Konfirmasi Kata Sandi">
                                </div>
                            </div>
                        </div>
